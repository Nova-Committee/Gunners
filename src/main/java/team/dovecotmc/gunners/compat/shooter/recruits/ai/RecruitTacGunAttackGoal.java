...
import team.dovecotmc.gunners.compat.ai.TacGunAttackGoal;

public class RecruitTacGunAttackGoal extends TacGunAttackGoal<CrossBowmanEntity> {
    private int seeTime;

    public RecruitTacGunAttackGoal(CrossBowmanEntity shooter, double stopRange) {
